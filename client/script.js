...
function getLimitedSearch() {
    ...
    var patternReq = String(document.getElementById("search-by-given").value);
    var nameReq = String(document.getElementById("value-to-search").value);
    ...
    fetch(`/api/superheroes/${parsed}`)
        .then(res => res.json() //used to send JSON response, pass json object as arguement, converted to json string 
            .then(data => {
                ...
                // if(elements.at(0).textContent != headerName.textContent){
                //     divResult.innerHTML = "";
                // }
    ...
    fetch(`/api/superheroes/${parsed}/powers`)
        .then(res => res.json()
            .then(dataPower => {
                ...
                // console.log(elements.at(0));
                // if(elements.at(0).textContent != headerForPowers.textContent){
                //     divResult.innerHTML = "";
                // }
                // powers.textContent = "";
